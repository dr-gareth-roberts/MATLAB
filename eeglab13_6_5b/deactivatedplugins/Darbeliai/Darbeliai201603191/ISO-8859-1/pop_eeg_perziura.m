...
% eeg_perziura - EEG ra perira naujame lange
% pop_eeg_perziura(EEG)
% pop_eeg_perziura(EEG1, EEG2)
% pop_eeg_perziura(EEG1, EEG2, 'title', 'Savitas lango pavadinimas')
% pop_eeg_perziura(EEG1, [], 'ICA', 1) - rodyti ne kanalo signal, bet NKA kompoenentes
% pop_eeg_perziura(EEG1, EEG2, 'zymeti', 1) - eksperimentinis laiko atkarp ymjimas
% pop_eeg_perziura('narsyti', 1) - eksperimentin rinkmen narykl one (vieno keltino rao pasirinkimas)
% pop_eeg_perziura('narsyti', 2) - dvi eksperimentins rinkmen narykls one (dviej palygintin ra pasirinkimas)
%
...
i=get(handles.edit2,'String'); % klimo
