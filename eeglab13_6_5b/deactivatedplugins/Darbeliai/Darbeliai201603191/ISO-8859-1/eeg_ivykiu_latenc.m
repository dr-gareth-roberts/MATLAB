...
% eeg_ivykiu_latenc - vyki latencija, atsivelgiant  karpymus (boundary)
...
% 
% Neatsivelgiant  karpymus, rezultatas panaus kaip
...
if nargout >= 5 && any(ismember(fieldnames(g),{'type' 'notype' 'index'})); 
    % btina prasukti su 'boundary' vykiu, geriau be joki parametr
...
Ivykiai2={}; try Ivykiai2={g(1).type}; catch; end; % YRA VYKIAI
if ~isempty(Ivykiai2)
...
Ivykiai3={}; try Ivykiai3={g(1).notype}; catch; end; % NRA VYKI
if ~isempty(Ivykiai3)
...
% Pakeisti EEG.times atitikmens reikmes
