%
%
% Darb vykdymas pagal i anksto apraytus j parinki rinkinius
%
% GUI versija
%
%
...
NaujaAntraste=[ num2str(DarboNr + str2num(get(handles.text_atlikta_darbu,'String'))) ' meta darb., ' kelintas_failas '/' num2str(Pasirinktu_failu_N) ' r.'];
disp(NaujaAntraste);
...
% suderinamumas su pirmuoju pop_meta_drb parinki valdymu
...
rinkiniai_orig={'numatytas'}; % Net jei tokio ir dar nra, jis sukuriamas paleidiant dialog
try    
    function_dir=regexprep(mfilename('fullpath'),[ mfilename '$'], '' );
