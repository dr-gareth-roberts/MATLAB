...
% Last Modified by GUIDE v2.5 12-Jul-2016 23:58:38
...
% Load ERP data if not present under STUDY.cluster
if ~isfield(STUDY.cluster, 'erpdata')
    disp('Loading cluster ERPs... (done only once)')
...
% Set the default window length to be that of the data
erpTimes = STUDY.cluster(1,3).erptimes;
...
% Populate drop down menu with var1-var2 combinations from STUDY
