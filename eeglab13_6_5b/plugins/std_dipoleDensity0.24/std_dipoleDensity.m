...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% find out if 'group' is non-exist, var1, or var2 %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
designLabel = {STUDY.design(currentDesign).variable.label};
groupFieldIdx = find(strcmp(designLabel, 'group')); % find the slot index that has 'group'
...
for n = 1:5
    if varargin{1,n}.cluster>1 & varargin{1,n}.group>1
        tmpCluster   = varargin{1,n}.cluster;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        brainBlobBrowser('data',dens3d{1})
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% compute 'group' variable index %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
designLabel = {STUDY.design(STUDY.currentdesign).variable.label};
groupFieldIdx = find(strcmp(designLabel, 'group')); % is 'group' non-exist, var1, or var2?
if isempty(groupFieldIdx) % no 'group'
